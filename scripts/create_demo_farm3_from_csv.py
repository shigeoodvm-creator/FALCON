"""
FALCON2 - 乳検CSVからデモ農場3を作成
CSVファイルを読み込んで、DemoFarm3を作成し、牛・分娩イベント・乳検イベントを登録する
...
def main():
    ...
    parser = argparse.ArgumentParser(description='乳検CSVからデモ農場3を作成')
    ...
    try:
        # FarmCreatorを使用してデモ農場3を作成
        farm_path = Path("C:/FARMS/DemoFarm3")
